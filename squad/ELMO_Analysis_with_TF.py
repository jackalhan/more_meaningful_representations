...
start = datetime.datetime.now()
word_embeddings, voc, vocab_file = ee.list_to_token_embeddings(  batch=tokenized_paragraphs+tokenized_questions,
                                                                 inject_tfidf=True,
...
# # CHAR EMBEDDINGS START
# print('Paragraphs: Embedding')
# paragraphs_embeddings = np.asarray(ee.list_to_embeddings_with_dump(tokenized_paragraphs, _s['slice_index'], paragraph_embeddings_file))
...
# print(20* '-')
# print('Question: Embedding')
# questions_embeddings = np.asarray(ee.list_to_embeddings_with_dump(tokenized_questions, _s['slice_index'], question_embeddings_file))
