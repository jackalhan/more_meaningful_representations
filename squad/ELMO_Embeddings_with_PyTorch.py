...
paragraphs_embeddings = np.asarray(ee.embed_batch(tokenized_paragraphs))
paragraphs_embeddings = np.apply_over_axes(np.mean, paragraphs_embeddings, _s['axis'])
paragraphs_embeddings = np.reshape(paragraphs_embeddings,(paragraphs_embeddings.shape[0], paragraphs_embeddings.shape[3]))
...
questions_embeddings = np.asarray(ee.embed_batch(tokenized_questions))
questions_embeddings = np.apply_over_axes(np.mean, questions_embeddings, _s['axis'])
questions_embeddings = np.reshape(questions_embeddings,(questions_embeddings.shape[0], questions_embeddings.shape[3]))
