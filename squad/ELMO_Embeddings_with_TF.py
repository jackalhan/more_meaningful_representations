...
def get_elmo_embeddings(tokenized_questions, tokenized_paragraphs, token_embeddings_guideline_file,
    ...
    corpus_as_tokens = corpus_as_tokens if resource['is_demo_slice'] is None else corpus_as_tokens[resource['is_demo_slice']]
    ...
    if not is_google_elmo:
        ...
        if os.path.exists(token_embeddings_file.replace('@@', str('old_api_@@')).replace('@@', str(total_parition_size_for_old_api))):
            ...
            if not resource['old_contextualized_elmo']:
                ...
                UTIL.generate_and_dump_contextualized_elmo_embeddings(tokenized_questions,
                                                                      tokenized_paragraphs,
                                                                      voc_file_name,
                                                                      elmo_options_file,
                                                                      weight_file,
