...
dev_examples, dev_eval, dev_questions, dev_paragraphs, dev_q_to_ps = process_file(squad_file.format(DEV), DEV, dev_word_counter, dev_char_counter)
...
if dataset_type ==  TRAIN:
    train_examples, train_eval, train_questions, train_paragraphs, train_q_to_ps = process_file(squad_file.format(TRAIN), TRAIN, train_word_counter, train_char_counter)
    print('#' * 20)
...
for _token_embed_pack in [(weighted_token_embeddings, 'with_idf')]:
    ...
    for _a_b_c in _a_b_c_s:
        ...
        if is_filtered_by_answers_from_rnet:
            ...
            filter_prediction_and_calculate_similarity_and_dump(paragraphs_embeddings, questions_embeddings, answers, paragraphs, eval,
